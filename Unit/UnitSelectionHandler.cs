...
public class UnitSelectionHandler : MonoBehaviour
{
    ...
    public List<Unit> SelectUnits { get; } = new List<Unit>();
    ...
    private void Start()
    {
        ...
        GameOver.ClientOnGameOver += ClientHandlerGamOver;
    }
    ...
    void StartSelectionArea()
    {
        ...
        {
            foreach (Unit selectUnit in SelectUnits)
            {
                selectUnit.Deselect();
            }
            SelectUnits.Clear();
    ...
    private void ClearSelectionArea()
    {
        ...
        {
            if(SelectUnits.Contains(unit)) { continue; }
    ...
    void ClientHandlerGamOver(string winnerName)
    {
        enabled = false;
    }
}
